...
//retrieve data
d3.csv('./assets/data/data.csv').then(function(maData) {

    console.log(maData);

    //Parse data
    maData.forEach(function(data) {
    ...
    var xLinearScale = xScale(maData, chosenXAxis);
    var yLinearScale = yScale(maData, chosenYAxis);
    ...
    xLabelsGroup.selectAll('text')
        .on('click', function() {
            ...
            if (value != chosenXAxis) {
                ...
                xLinearScale = xScale(maData, chosenXAxis);
    ...
    yLabelsGroup.selectAll('text')
        .on('click', function() {
            ...
            if (value != chosenYAxis) {
                ...
                //update Y scale
                yLinearScale = yScale(maData, chosenYAxis);
